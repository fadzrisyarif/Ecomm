...
<div class="container">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="namabrg" name="namabrg" autofocus value="<?= $product['namabrg'] ?>" required>
  </div>
  <div class="mb-3">
    <label for="hargabrg" class="form-label">Harga Barang</label>
    <input type="text" class="form-control" id="hargabrg" name="hargabrg" value="<?= $product['hargabrg'] ?>" required>
  </div>
  <div class="mb-3">
    <label for="jenisbrg" class="form-label">Jenis Barang</label>
    <input type="text" class="form-control" id="jenisbrg" name="jenisbrg" value="<?= $product['jenisbrg'] ?>" required>
  <div class="mb-3">
